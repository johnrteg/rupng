...
import { branches, bumpVersion, commitPush, createPR, pull, reinstall, repoStatus, test } from "./repo";
...
export function registerIpc( getWindow : () => BrowserWindow | null ) : void
{
    ...
    ipcMain.handle( IPC.repoCommitPush, ( _e, branch : string, message : string ) => commitPush( branch, message ) );
    ipcMain.handle( IPC.repoCreatePR, ( _e, branch : string, title : string ) => createPR( branch, title ) );
