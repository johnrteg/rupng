...
const api =
{
    ...
    repoCommitPush : ( branch : string, message : string ) : Promise<number> => ipcRenderer.invoke( IPC.repoCommitPush, branch, message ),
    repoCreatePR  : ( branch : string, title : string ) : Promise<number> => ipcRenderer.invoke( IPC.repoCreatePR, branch, title ),
