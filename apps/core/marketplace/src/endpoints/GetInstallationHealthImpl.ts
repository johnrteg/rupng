//
import { GetInstallationHealth, Marketplace } from "@repo/api";
import { NetworkUtils, type Type } from "@repo/common";
import { RestfulEndpoint } from "@repo/endpoint";
import MarketplaceService from "../services/MarketplaceService";

//
// Read the stored health (no live check — see PostInstallationHealthCheck for that).
//
export class GetInstallationHealthImpl extends GetInstallationHealth
{
    ...
    public async execute( auth : RestfulEndpoint.Authentication ) : Promise<RestfulEndpoint.Response>
    {
        ...
        return { status: NetworkUtils.Status.OK, data: got.data.health };
    }
}

export default GetInstallationHealthImpl;
