...
**Where:** [auth/SPECS.md § RBAC](../apps/core/auth/specs/SPECS.md), [endpoint/SPECS.md](../packages/endpoint/SPECS.md), [events README](../packages/events/README.md).
...
| Event vocabulary, per-event consume floor, PII-light envelope | [packages/events/README.md](../packages/events/README.md) |
