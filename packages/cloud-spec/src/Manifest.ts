...
import {
    ...
    EventBusSpec, LambdaSpec, ApiSpec, KafkaTopicSpec, KafkaBindingSpec,
...
/**
 * A service's complete cloud declaration. Exported from `<service>/src/infra.ts`
