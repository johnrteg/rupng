...
//
// A real service exports its manifest from `<service>/src/infra.ts`. The /cloud
...
export const widgetManifest : ResourceManifest =
{
    ...
    owns:
    {
        ...
        // 6. A Lambda worker triggered by the queue. The CDK app injects the bucket
