...
import type { Events } from '@repo/events';   // the canonical service id this Application carries
...
export class Application
{
    ...
    // The canonical service id (`Events.Service.*`) — the event `source`, resource-name prefix, and
    // base of the process/log name. `serviceName` is the full instance name: `service` or `service:role`.
    protected   readonly service     : Events.Service;
    ...
    ////////////////////////////////////////////////////////////////////////
    /**
     * @param service   the canonical service id (`Events.Service.*`) — every deployable has one.
