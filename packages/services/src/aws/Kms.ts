...
export class Kms
{
     ...
     */
    encrypt( keyKey : ResourceKey, plaintext : Uint8Array ) : Promise<Type.Result<Uint8Array>>
    {
        return ResultUtils.from( async () : Promise<Uint8Array> =>
        {
     ...
     */
    decrypt( ciphertext : Uint8Array ) : Promise<Type.Result<Uint8Array>>
    {
        return ResultUtils.from( async () : Promise<Uint8Array> =>
        {
     ...
     */
    dataKey( keyKey : ResourceKey, keySpec : Kms.KeySpec = Kms.KeySpec.AES_256 ) : Promise<Type.Result<{ plaintext : Uint8Array; encrypted : Uint8Array }>>
    {
        return ResultUtils.from( async () : Promise<{ plaintext : Uint8Array; encrypted : Uint8Array }> =>
        {
