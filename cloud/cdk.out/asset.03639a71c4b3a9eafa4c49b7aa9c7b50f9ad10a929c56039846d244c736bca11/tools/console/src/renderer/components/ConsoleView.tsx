...
type TabValue = LogStream | "api" | "claude" | "jobs";
...
{
    // a frontend (SPA) has no Docker image and serves no API endpoints — drop those tabs
    const visibleStreams : LogStream[] = isFrontend ? LOG_STREAMS.filter( ( s ) => s !== "image" ) : LOG_STREAMS;
