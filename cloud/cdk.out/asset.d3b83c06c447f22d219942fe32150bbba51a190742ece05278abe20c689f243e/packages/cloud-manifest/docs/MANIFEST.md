...
in** — there is no `mode` field. The `topic` **is** the event identity from [`@repo/system`](../../system/README.md):
...
See [`@repo/system`](../../system/README.md) and [`/cloud/SPECS.md` → *Publishers & subscribers*](../../../cloud/SPECS.md).
