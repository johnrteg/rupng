...
// src/jobs/AppCacheInvalidationJob.ts
var AppCacheInvalidationJob_exports = {};
__export(AppCacheInvalidationJob_exports, {
  AppCacheInvalidationJob: () => AppCacheInvalidationJob,
  default: () => AppCacheInvalidationJob_default,
  handler: () => handler
});
module.exports = __toCommonJS(AppCacheInvalidationJob_exports);
...
// src/jobs/AppCacheInvalidationJob.ts
var AppCacheInvalidationJob = class extends AppJob_default {
  /////////////////////////////////////////////////////////////////////
  constructor() {
  ...
  async handler(event, _context) {
    this.log.info("AppCacheInvalidationJob", { received: event !== void 0 });
  }
};
var job = new AppCacheInvalidationJob();
var handler = (event, context) => job.invoke(event, context);
var AppCacheInvalidationJob_default = AppCacheInvalidationJob;
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  AppCacheInvalidationJob,
  handler
});
//# sourceMappingURL=AppCacheInvalidationJob.js.map
