...
| [packages/endpoint/SPECS.md](packages/endpoint/SPECS.md) · [packages/events/README.md](packages/events/README.md) | The API contract (one def → client/server/docs) + the **event vocabulary** (object/verb/payload). |
